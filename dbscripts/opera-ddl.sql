...
INSERT INTO TimeCurrent.dbo.tblIntegration_Config (CfgKey,CfgValue) Values ('DATAMAPPER_THREADPOOL_SCHEDULER_TERMINATION_TIME_INSECONDS','180');

INSERT INTO TimeCurrent.dbo.tblIntegration_Config (CfgKey,CfgValue) Values ('AZURE_CONSUMER_CLUSTER_1','Avionte');
INSERT INTO TimeCurrent.dbo.tblIntegration_Config (CfgKey,CfgValue) Values ('AZURE_CONSUMER_CLUSTER_2','EmployBridge');
